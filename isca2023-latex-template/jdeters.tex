...
\lstdefinestyle{mystyle}{
    ...
    frame=lines,
    %just for Chisel
    emph={Module, IO, Input, Output, UInt, Bool, Wire, Vec, before, after, extend, in, register, insert, apply, Pointcutter, AfterToken, AfterState, Some, when, :=, &&, before, around, insert, in, register},
